/******************************************************************************
* Copyright 2018-2023 545122859@qq.com
...
#define DEBUG_CMD_DECLARE
//在此处声明串口调试的函数
//DEBUG_CMD_FN_DECLARE ( test );
//DEBUG_CMD_FN_DECLARE ( flash_drv );
//DEBUG_CMD_FN_DECLARE ( reg_record );
//DEBUG_CMD_FN_DECLARE ( reg_table );
//DEBUG_CMD_FN_DECLARE ( dev_config );
//DEBUG_CMD_FN_DECLARE ( timer_test );
//DEBUG_CMD_FN_DECLARE ( card_app );
//DEBUG_CMD_FN_DECLARE ( card_cpu );
//DEBUG_CMD_FN_DECLARE ( card_ic );
//DEBUG_CMD_FN_DECLARE ( card_sfz );
DEBUG_CMD_FN_DECLARE ( card_ic_sender );
#define DEBUG_CMD_TABLE
//在此处注册串口调试的函数
static DEBUG_CMD_STR debug_cmd_table[]=
{
//	DEBUG_CMD_DEFINE ( test,         "describ" ),
//	DEBUG_CMD_DEFINE ( flash_drv,    "flash_drv flash_read flash_write flash_erase" ),
//	DEBUG_CMD_DEFINE ( reg_record,   "reg_record" ),
//	DEBUG_CMD_DEFINE ( reg_table,    "reg_table" ),
//	DEBUG_CMD_DEFINE ( dev_config,   "dev_config" ),
//	DEBUG_CMD_DEFINE ( timer_test,   "test timer_set" ),
//	DEBUG_CMD_DEFINE ( card_app,     "test card_app" ),
//	DEBUG_CMD_DEFINE ( card_cpu,     "test card_cpu" ),
//	DEBUG_CMD_DEFINE ( card_ic,      "test card_ic" ),
//	DEBUG_CMD_DEFINE ( card_sfz,     "test card_sfz" ),
	DEBUG_CMD_DEFINE ( card_ic_sender,     "test card_ic_sender" ),
};
